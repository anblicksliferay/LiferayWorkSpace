...
import com.astra.anblicks.pdca.service.ci_kpiLocalService;
...
/**
 * Provides the base implementation for the ci_kpi local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.anblicks.pdca.service.impl.ci_kpiLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class ci_kpiLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements ci_kpiLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.astra.anblicks.pdca.service.ci_kpiLocalServiceUtil} to access the ci_kpi local service.
	 */
	...
	public ci_kpi addci_kpi(ci_kpi ci_kpi) {
		...
		return ci_kpiPersistence.update(ci_kpi);
	}
	...
	public ci_kpi createci_kpi(long ciKpiId) {
		return ci_kpiPersistence.create(ciKpiId);
	}
	...
	public ci_kpi deleteci_kpi(long ciKpiId) throws PortalException {
		return ci_kpiPersistence.remove(ciKpiId);
	}
	...
	public ci_kpi deleteci_kpi(ci_kpi ci_kpi) {
		return ci_kpiPersistence.remove(ci_kpi);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ci_kpi.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return ci_kpiPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return ci_kpiPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return ci_kpiPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return ci_kpiPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public ci_kpi fetchci_kpi(long ciKpiId) {
		return ci_kpiPersistence.fetchByPrimaryKey(ciKpiId);
	}
	...
	public ci_kpi getci_kpi(long ciKpiId) throws PortalException {
		return ci_kpiPersistence.findByPrimaryKey(ciKpiId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(ci_kpiLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ci_kpi.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("ciKpiId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(ci_kpiLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ci_kpi.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("ciKpiId");
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return ci_kpiLocalService.deleteci_kpi((ci_kpi)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return ci_kpiPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ci_kpi> getci_kpis(int start, int end) {
		return ci_kpiPersistence.findAll(start, end);
	}
	...
	public int getci_kpisCount() {
		return ci_kpiPersistence.countAll();
	}
	 ...
	 */
	public ci_kpiLocalService getci_kpiLocalService() {
	 ...
	 */
	public void setci_kpiLocalService(ci_kpiLocalService ci_kpiLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.astra.anblicks.pdca.model.ci_kpi",
			ci_kpiLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.astra.anblicks.pdca.model.ci_kpi");
	}
	...
	public String getOSGiServiceIdentifier() {
		return ci_kpiLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = ci_kpiPersistence.getDataSource();
	...
	@BeanReference(type = ci_kpiLocalService.class)
	protected ci_kpiLocalService ci_kpiLocalService;
